...
+ (void)guardExceptionExchangeMethod {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [self exchangeInstanceMethodForClass:__NSCFConstantString
                ...
                withSwizzledSelector:@selector(eg_cf_stringByReplacingOccurrencesOfString:withString:options:range:)];
        
        [self exchangeInstanceMethodForClass:NSTaggedPointerString
                    originalSelector:@selector(stringByReplacingOccurrencesOfString:withString:options:range:)
                withSwizzledSelector:@selector(eg_tp_stringByReplacingOccurrencesOfString:withString:options:range:)];
        
        // - stringByReplacingCharactersInRange:withString:
        [self exchangeInstanceMethodForClass:__NSCFConstantString
                    originalSelector:@selector(stringByReplacingCharactersInRange:withString:)
                withSwizzledSelector:@selector(eg_cf_stringByReplacingCharactersInRange:withString:)];
        
        [self exchangeInstanceMethodForClass:NSTaggedPointerString
                    originalSelector:@selector(stringByReplacingCharactersInRange:withString:)
                withSwizzledSelector:@selector(eg_tp_stringByReplacingCharactersInRange:withString:)];
...
// + stringWithCString:encoding:
+ (nullable instancetype)eg_stringWithCString:(const char *)cString encoding:(NSStringEncoding)enc {
    NSString *subString = nil;
    @try {
...
- (NSRange)eg_cf_rangeOfString:(NSString *)searchString
    ...
    NSRange range;
    @try {
        range = [self eg_cf_rangeOfString:searchString options:mask range:rangeOfReceiverToSearch locale:locale];
    }
    @catch (NSException *exception) {
        [[SNExceptionGuarder shareInstance] noteErrorWithException:exception defaultOP:SNExceptionGuarderReturnNil];
    }
...
- (NSRange)eg_tp_rangeOfString:(NSString *)searchString
    ...
    NSRange range;
    @try {
        range = [self eg_tp_rangeOfString:searchString options:mask range:rangeOfReceiverToSearch locale:locale];
    }
    @catch (NSException *exception) {
        [[SNExceptionGuarder shareInstance] noteErrorWithException:exception defaultOP:SNExceptionGuarderReturnNil];
    }
...
- (instancetype)eg_cf_initWithFormat:(NSString *)format
    ...
    NSString *newStr = nil;
    @try {
        newStr = [self eg_cf_initWithFormat:format locale:locale arguments:argList];
    }
    @catch (NSException *exception) {
        newStr = nil;
        [[SNExceptionGuarder shareInstance] noteErrorWithException:exception defaultOP:SNExceptionGuarderReturnNil];
...
- (instancetype)eg_ph_initWithFormat:(NSString *)format
    ...
    NSString *newStr = nil;
    @try {
        newStr = [self eg_ph_initWithFormat:format locale:locale arguments:argList];
    }
    @catch (NSException *exception) {
        newStr = nil;
        [[SNExceptionGuarder shareInstance] noteErrorWithException:exception defaultOP:SNExceptionGuarderReturnNil];
...
- (instancetype)eg_tp_initWithFormat:(NSString *)format
    ...
    NSString *newStr = nil;
    @try {
        newStr = [self eg_tp_initWithFormat:format locale:locale arguments:argList];
    }
    @catch (NSException *exception) {
        newStr = nil;
        [[SNExceptionGuarder shareInstance] noteErrorWithException:exception defaultOP:SNExceptionGuarderReturnNil];
